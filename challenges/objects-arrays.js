...
console.log(`${tyrannosaurus.name} says... RAWERSRARARWERSARARARRRR!`);
...
universities.sort(function(x, y) {
  return x - y;
...
const lowerPopulation = zooAnimals.filter(zooAnimal => (zooAnimal)=>zooAnimal.population < 5);
